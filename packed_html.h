...
static const char login_html[] = "<!DOCTYPE html><html lang='en'>"
    ...
    "<style type='text/css'>"
    "*{outline:none;}"
    "body{background-color:#F5F5F5;color:#3c3f41;margin:0;padding:0;font:16px/1.4 Helvetica,Arial,sans-serif;}"
    "div.content{width:500px;margin:2em auto;padding:1em;background-color:#E6E6FA;border-radius:10px;}"
    "h1{margin:5px;}"
...
static const char about_html[] = "<!DOCTYPE html><html lang='en'>"
    ...
    "<style type='text/css'>"
    "*{outline:none;}"
    "body{background-color:#F5F5F5;color:#3c3f41; margin:0;padding:20px;font:16px/1.4 Helvetica,Arial,sans-serif;}"
    "h1{margin:5px;}h1 a{color:#3c3f41;}"
    ".code{width:calc(100% - 40px);padding: 20px;background-color:#3c3f41;color:#F5F5F5;border-radius:0.2em;}"
    "</style>"
    "</head><body>"
    "<div class='content'>"
    ...
    "<p class='code'>curl -H \"Transfer-Encoding: chunked\" -v -F file=@[file name] [server url]/[path]?name=[upload as file name]&user=[user name]&pass=[password]</p>"
    "<h2>File Download</h2>"
...
static const char toolbar_css[] = "<style>"
    "#toolbar{width: 100vw;margin:0;padding:0 10px;display:flex;background-color:#E6E6FA;color:#2c2c2c;position:fixed;top:0;left:0;}"
