...
static const char upload_file_js[] = "<script>"
    ...
    "function uploadFile(file){"
        "dropArea.innerHTML='Uploading <span class=\"animate\">'+file.name+'</span><div id=\"progbar\"></div>';"
        "dropArea.setAttribute('style','padding-bottom:15px');"
        ...
        "request.upload.addEventListener('progress',function(e){"
            ...
            "document.getElementById('progbar').setAttribute('style','width:' + percent_completed + '%');"
        "});"
        "request.addEventListener('load',function(e){"            
            "window.location.reload(false);"
        "});"
        "request.addEventListener('error',function(e){"
            "dropArea.innerHTML='Failed due to server error! ' + request.response;"
        "});"
